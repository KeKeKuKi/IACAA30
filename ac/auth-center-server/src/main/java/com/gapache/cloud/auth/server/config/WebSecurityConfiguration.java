...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    @Bean
    public BeforeUsernamePasswordFilter beforeUsernamePasswordFilter() {
        return new BeforeUsernamePasswordFilter();
    }
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                ...
                .antMatchers(HttpMethod.POST, "/api/role/list").permitAll()
                .antMatchers(HttpMethod.PUT, "/api/role").permitAll()
                .antMatchers(HttpMethod.POST, "/api/role/deleteAll").permitAll()
                .antMatchers(HttpMethod.POST, "/api/role").permitAll()
                .antMatchers(HttpMethod.POST, "/api/permission/listByRole").permitAll()
                .antMatchers(HttpMethod.POST, "/api/user/setUserRole").permitAll()
                .antMatchers(HttpMethod.POST, "/api/role/page").permitAll()
                .antMatchers(HttpMethod.POST, "/api/permission/list").permitAll()
    ...
    static class BeforeUsernamePasswordFilter extends OncePerRequestFilter {
        ...
        protected void doFilterInternal(@NonNull HttpServletRequest request, @NonNull HttpServletResponse response, @NonNull FilterChain filterChain) throws ServletException, IOException {
            ...
            if (accessCard.getUserId() != null) {
                ...
                userDetails.setId(accessCard.getUserId());
                userDetails.setUsername(accessCard.getUsername());
                userDetails.setClientId(accessCard.getClientId());
                userDetails.setCustomerInfo(accessCard.getCustomerInfo());
                userDetails.setAuthorities(accessCard.getAuthorities().stream().map(SimpleGrantedAuthority::new).collect(Collectors.toList()));
